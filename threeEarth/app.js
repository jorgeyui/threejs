...
function main(){
  ...
  const defaultCordinates= [36.204824, 138.252924]; //Default location for this project(Cordinates of Idukki, Kerala, India)
  ...
  scene.background = new THREE.TextureLoader('https://img.freepik.com/premium-photo/v478-wan-16-technology-converted-eps_53876-159426.jpg');
  scene.add(overlay());
